...
if __name__=='__main__': #kann man das auch noch anders kontrollieren, dass ein Teil nur ausgeführt wird, wenn die Datei von einer spezifischen anderen Datei aufgerufen/importiert wird?
	import environment
	input_file_network = "../manual_example_data/test_saved_network.txt" #muss später noch allgemein fürs repo funktionieren, nicht nur für meinen PC, ist aber nur ein test #später mit sys?
	...
	#environment.plot_with_networkx() #warum steht das hier? geht doch auch ohne oder? 
